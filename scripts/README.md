...
5. `05_demonstrate_enriched_exposure_measures.ipynb` showcases the enriched table and creates demonstration figures.

The public repository includes a scrambled metadata fixture so notebooks 04 and 05 can run without scraping YouTube. The public fake video IDs are intentionally not scrapeable.
