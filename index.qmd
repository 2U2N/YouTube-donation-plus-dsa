...
```{mermaid}
flowchart TD
  A["Google Takeout-data<br/>watch histories, search histories, subscriptions"] --> B["Clean donated histories"]
  C["Video-level metadata<br/>scraped metadata"] --> D["Prepare metadata table"]
